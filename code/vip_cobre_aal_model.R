...
print(str_c("Doing job COBRE AAL"))

source("code/calculate_vip.R")

# Data --------------------------------------------------------------------
M <- read_rds("results/cobre_aal_rpls_model_K_3.Rds")
...
# tictoc::toc()
write_rds(res, glue::glue("results/cobre_aal_vip/cobre_aal_vip_sim_{job_num}.Rds"))
